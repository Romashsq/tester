...
class Human:
    ...
    def days_indexes(self):
        ...
        print(f"gladness = {self.gladness} lvl happiness")
        print(f"brand of car = {self.brand}")
        print(f"lvl of fuel in the car = {self.fuel}")
        print(f"your car car cool, if its start is more than 0 = {self.strength}")
        print(f"home tidy lvl = {self.home.mess}")
        print(f"lvl food = {self.home.food}")
